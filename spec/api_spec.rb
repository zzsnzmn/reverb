...
describe ReverbAPI::API do
  ...
  it 'handles post with strings' do
    ...
    last_response.body.should eql '"saved"'
  ...
  it 'get by gender' do
    ...
    last_response.body.should eql '[{"last_name":"a","first_name":"a","gender":"female","date_of_birth":"01/18/1990","favorite_color":"blue"},' +
  ...
  it 'get by name' do
    ...
    get '/records/name'
    last_response.status.should eql 200
    last_response.body.should eql '[{"last_name":"z","first_name":"a","gender":"male","date_of_birth":"01/18/1990","favorite_color":"blue"},' +
                                  '{"last_name":"y","first_name":"a","gender":"male","date_of_birth":"01/18/1990","favorite_color":"blue"},' +
                                  '{"last_name":"x","first_name":"a","gender":"female","date_of_birth":"01/18/1990","favorite_color":"blue"},' +
  ...
  it 'get by birthdate' do
    ...
    w.save(Person.new('y', 'a', 'male', 'blue', '1/18/1991'))
    get '/records/birthdate'
    last_response.status.should eql 200
    last_response.body.should eql '[{"last_name":"z","first_name":"a","gender":"male","date_of_birth":"01/18/1920","favorite_color":"blue"},' +
